...
```sh
pip install git+https://github.com/RSC-NA/rsc-api-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/RSC-NA/rsc-api-client.git`)
...
*CsvApi* | [**csv_player_mmr_export_list**](docs/CsvApi.md#csv_player_mmr_export_list) | **GET** /csv/player-mmr-export/ | 
*CsvApi* | [**csv_player_mmr_export_retrieve**](docs/CsvApi.md#csv_player_mmr_export_retrieve) | **GET** /csv/player-mmr-export/{id}/ | 
...
*FranchisesApi* | [**franchises_add_agm_update**](docs/FranchisesApi.md#franchises_add_agm_update) | **PUT** /franchises/{id}/add_agm/ | 
...
*FranchisesApi* | [**franchises_remove_agm_update**](docs/FranchisesApi.md#franchises_remove_agm_update) | **PUT** /franchises/{id}/remove_agm/ | 
...
*LeaguesApi* | [**leagues_create_future_season_create**](docs/LeaguesApi.md#leagues_create_future_season_create) | **POST** /leagues/{id}/create_future_season/ | 
...
*MembersApi* | [**members_elevated_roles_destroy**](docs/MembersApi.md#members_elevated_roles_destroy) | **DELETE** /members/{member_id}/elevated_roles/{id}/ | 
...
*MembersApi* | [**members_elevated_roles_retrieve**](docs/MembersApi.md#members_elevated_roles_retrieve) | **GET** /members/{member_id}/elevated_roles/{id}/ | 
...
*StatsApi* | [**stats_idr_list**](docs/StatsApi.md#stats_idr_list) | **GET** /stats/idr/ | 
*StatsApi* | [**stats_idr_retrieve**](docs/StatsApi.md#stats_idr_retrieve) | **GET** /stats/idr/{id}/ | 
...
*TrackerLinksApi* | [**tracker_links_spider_create**](docs/TrackerLinksApi.md#tracker_links_spider_create) | **POST** /tracker-links/spider/ | 
...
## Documentation For Models
 ...
 - [FutureSeasonPlan](docs/FutureSeasonPlan.md)
 - [FutureSeasonTierOverride](docs/FutureSeasonTierOverride.md)
 - [FutureSeasonTierPlan](docs/FutureSeasonTierPlan.md)
 - [HighLevelMatch](docs/HighLevelMatch.md)
 - [IDRResult](docs/IDRResult.md)
 ...
 - [LeagueFutureSeasonCreate](docs/LeagueFutureSeasonCreate.md)
 ...
 - [MatchResultsBallchasingGroup](docs/MatchResultsBallchasingGroup.md)
 - [MatchScoreReportRequest](docs/MatchScoreReportRequest.md)
 - [MatchScoreReportRequestBallchasingGroup](docs/MatchScoreReportRequestBallchasingGroup.md)
 ...
 - [PatchedElevatedRoleUpdate](docs/PatchedElevatedRoleUpdate.md)
 ...
 - [PlayerMMRExport](docs/PlayerMMRExport.md)
 ...
 - [TierReference](docs/TierReference.md)
 ...
 - [TrackerLinkName](docs/TrackerLinkName.md)
 - [TrackerLinkSpiderRequest](docs/TrackerLinkSpiderRequest.md)
