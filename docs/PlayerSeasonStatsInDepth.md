...
**playmakers_rank** | **int** |  | 
**saviors_rank** | **int** |  | 
**goals_against_while_last_defender_rank** | **int** |  | 
**time_powerslide_rank** | **int** |  | 
**count_powerslide_rank** | **int** |  | 
**amount_collected_rank** | **int** |  | 
**amount_stolen_rank** | **int** |  | 
**amount_collected_big_rank** | **int** |  | 
**amount_stolen_big_rank** | **int** |  | 
**amount_collected_small_rank** | **int** |  | 
