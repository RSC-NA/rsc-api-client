...
async with rscapi.ApiClient(configuration) as api_client:
    ...
    action__in = 'action__in_example' # str | Comma separated list of action codes, e.g. `WCW,WCL`. (optional)
    category = 'category_example' # str | Event category code. (optional)
    category__in = 'category__in_example' # str | Comma separated list of category codes, e.g. `TRN,ANN`. (optional)
 ...
 **action__in** | **str**| Comma separated list of action codes, e.g. &#x60;WCW,WCL&#x60;. | [optional] 
 **category** | **str**| Event category code. | [optional] 
 **category__in** | **str**| Comma separated list of category codes, e.g. &#x60;TRN,ANN&#x60;. | [optional] 
