...
class MembersApi:
    ...
    @overload
    async def members_list(self, rsc_name : Annotated[Optional[StrictStr], Field(description="rsc_name")] = None, discord_username : Annotated[Optional[StrictStr], Field(description="discord_username")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None, **kwargs) -> MembersList200Response:  # noqa: E501
        ...

    @overload
    def members_list(self, rsc_name : Annotated[Optional[StrictStr], Field(description="rsc_name")] = None, discord_username : Annotated[Optional[StrictStr], Field(description="discord_username")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None, async_req: Optional[bool]=True, **kwargs) -> MembersList200Response:  # noqa: E501
        ...
    ...
    def members_list(self, rsc_name : Annotated[Optional[StrictStr], Field(description="rsc_name")] = None, discord_username : Annotated[Optional[StrictStr], Field(description="discord_username")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[MembersList200Response, Awaitable[MembersList200Response]]:  # noqa: E501
        ...
        >>> thread = api.members_list(rsc_name, discord_username, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.members_list_with_http_info(rsc_name, discord_username, limit, offset, **kwargs)  # noqa: E501

    @validate_arguments
    def members_list_with_http_info(self, rsc_name : Annotated[Optional[StrictStr], Field(description="rsc_name")] = None, discord_username : Annotated[Optional[StrictStr], Field(description="discord_username")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None, offset : Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """members_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.members_list_with_http_info(rsc_name, discord_username, limit, offset, async_req=True)
        >>> result = thread.get()
