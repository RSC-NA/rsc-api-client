...
class SeasonsApi:
    ...
    @validate_call
    async def seasons_signup_season(
        self,
        league: Annotated[StrictInt, Field(description="League to get current season for.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._seasons_signup_season_serialize(
            league=league,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def seasons_signup_season_with_http_info(
        self,
        league: Annotated[StrictInt, Field(description="League to get current season for.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def seasons_signup_season_without_preload_content(
        self,
        league: Annotated[StrictInt, Field(description="League to get current season for.")],
        _request_timeout: Union[
            None,
    ...
    def _seasons_signup_season_serialize(
        self,
        league,
        _request_auth,
        _content_type,
