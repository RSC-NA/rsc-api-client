...
class TrackerLinksApi:
    ...
    @overload
    async def tracker_links_partial_update(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, **kwargs) -> TrackerLink:  # noqa: E501
        ...

    @overload
    def tracker_links_partial_update(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, async_req: Optional[bool]=True, **kwargs) -> TrackerLink:  # noqa: E501
        ...

    @validate_arguments
    def tracker_links_partial_update(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, async_req: Optional[bool]=None, **kwargs) -> Union[TrackerLink, Awaitable[TrackerLink]]:  # noqa: E501
        """tracker_links_partial_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tracker_links_partial_update(id, data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the tracker_links_partial_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.tracker_links_partial_update_with_http_info(id, data, **kwargs)  # noqa: E501

    @validate_arguments
    def tracker_links_partial_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, **kwargs) -> ApiResponse:  # noqa: E501
        """tracker_links_partial_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tracker_links_partial_update_with_http_info(id, data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tracker_links_partial_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @overload
    async def tracker_links_update(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, **kwargs) -> TrackerLink:  # noqa: E501
        ...

    @overload
    def tracker_links_update(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, async_req: Optional[bool]=True, **kwargs) -> TrackerLink:  # noqa: E501
        ...

    @validate_arguments
    def tracker_links_update(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, async_req: Optional[bool]=None, **kwargs) -> Union[TrackerLink, Awaitable[TrackerLink]]:  # noqa: E501
        """tracker_links_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tracker_links_update(id, data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the tracker_links_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.tracker_links_update_with_http_info(id, data, **kwargs)  # noqa: E501

    @validate_arguments
    def tracker_links_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="A unique integer value identifying this tracker links.")], data : TrackerLink, **kwargs) -> ApiResponse:  # noqa: E501
        """tracker_links_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tracker_links_update_with_http_info(id, data, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tracker_links_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
