...
class WaiverOrder(BaseModel):
    ...
    tier_name: StrictStr
    basis: StrictStr
    completed_match_day: StrictInt
    order: List[WaiverOrderEntry]
    __properties: ClassVar[List[str]] = ["tier_id", "tier_name", "basis", "completed_match_day", "order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "basis": obj.get("basis"),
            "completed_match_day": obj.get("completed_match_day"),
            "order": [WaiverOrderEntry.from_dict(_item) for _item in obj["order"]] if obj.get("order") is not None else None
        })
        return _obj
