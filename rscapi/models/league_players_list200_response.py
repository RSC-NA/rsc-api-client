...
class LeaguePlayersList200Response(BaseModel):
    ...
    results: conlist(LeaguePlayer) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeaguePlayersList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeaguePlayersList200Response:
        """Create an instance of LeaguePlayersList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeaguePlayersList200Response.parse_obj(obj)

        _obj = LeaguePlayersList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [LeaguePlayer.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
