...
class CutSignInput(BaseModel):
    ...
    cut_player: StrictInt
    sign_player: StrictInt
    __properties: ClassVar[List[str]] = ["league", "executor", "admin_override", "notes", "cut_player", "sign_player"]
