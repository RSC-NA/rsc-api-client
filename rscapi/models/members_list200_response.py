...
class MembersList200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MembersList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MembersList200Response:
        """Create an instance of MembersList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MembersList200Response.parse_obj(obj)

        _obj = MembersList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
