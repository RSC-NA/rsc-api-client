...
class StatsDict(BaseModel):
    ...
    StatsDict
    """ # noqa: E501
    blue: TeamGameListResults
    orange: TeamGameListResults
    __properties: ClassVar[List[str]] = ["blue", "orange"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blue": TeamGameListResults.from_dict(obj["blue"]) if obj.get("blue") is not None else None,
            "orange": TeamGameListResults.from_dict(obj["orange"]) if obj.get("orange") is not None else None
        })
        return _obj
