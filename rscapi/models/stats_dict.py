...
class StatsDict(BaseModel):
    ...
    StatsDict
    """
    blue: TeamGameListResults = Field(...)
    orange: TeamGameListResults = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatsDict:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatsDict:
        """Create an instance of StatsDict from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatsDict.parse_obj(obj)

        _obj = StatsDict.parse_obj({
            "blue": TeamGameListResults.from_dict(obj.get("blue")) if obj.get("blue") is not None else None,
            "orange": TeamGameListResults.from_dict(obj.get("orange")) if obj.get("orange") is not None else None
        })
        return _obj
