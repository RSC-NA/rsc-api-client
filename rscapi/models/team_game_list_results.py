...
class TeamGameListResults(BaseModel):
    ...
    goals: StrictInt
    shots: StrictInt
    players: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=0, max_length=10)]
    __properties: ClassVar[List[str]] = ["team", "goals", "shots", "players"]
