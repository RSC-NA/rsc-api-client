...
class MatchesList200Response(BaseModel):
    ...
    results: conlist(MatchList) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchesList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatchesList200Response:
        """Create an instance of MatchesList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatchesList200Response.parse_obj(obj)

        _obj = MatchesList200Response.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [MatchList.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
