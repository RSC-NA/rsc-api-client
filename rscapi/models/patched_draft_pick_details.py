...
class PatchedDraftPickDetails(BaseModel):
    """
    ...
    tier: Optional[SeasonDraftPickList] = None
    franchise: Optional[DraftPickFranchise] = None
    ...
    players: Optional[List[DraftPickLeaguePlayer]] = None
