...
class TwosMasterMemberSheet(BaseModel):
    """
    ...
    twos_active: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["rsc_id", "rsc_name", "discord_id", "twos_active"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "twos_active": obj.get("twos_active")
        })
        return _obj
