...
class DropAPlayerFromALeague(BaseModel):
    """
    Drops a player from a league (prior to regular season)
    """ # noqa: E501
    league: StrictInt = Field(description="League of team player will be dropped from")
    __properties: ClassVar[List[str]] = ["league"]
