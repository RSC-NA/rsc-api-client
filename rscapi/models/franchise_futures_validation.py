...
class FranchiseFuturesValidation(BaseModel):
    """
    FranchiseFuturesValidation
    """ # noqa: E501
    league: StrictInt
    franchise_name: Annotated[str, Field(strict=True, max_length=255)]
    __properties: ClassVar[List[str]] = ["league", "franchise_name"]
