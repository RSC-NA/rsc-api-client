...
class SeasonLeague(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonLeague:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeasonLeague:
        """Create an instance of SeasonLeague from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeasonLeague.parse_obj(obj)

        _obj = SeasonLeague.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id")
        })
        return _obj
